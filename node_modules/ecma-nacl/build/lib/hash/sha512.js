...
exports.makeHasher = exports.hash = void 0;
/*
 ...
 * Length === 64.
 */
const iv = new Uint8Array([0x6a, 0x09, 0xe6, 0x67, 0xf3, 0xbc, 0xc9, 0x08,
...
function hash(inArr, arrFactory) {
    if (inArr.length > 0xffffffffffff) {
        throw new Error(`This implementation cannot handle byte arrays longer than 2^48 (256 TB).`);
    }
    if (!arrFactory) {
...
exports.hash = hash;
function makeHasher(isSingleUse = true, arrFactory) {
    if (!arrFactory) {
        arrFactory = arrays_1.makeFactory();
    }
