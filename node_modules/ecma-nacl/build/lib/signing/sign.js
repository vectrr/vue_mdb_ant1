...
exports.SECRET_KEY_LENGTH = exports.PUBLIC_KEY_LENGTH = exports.SEED_LENGTH = exports.JWK_ALG_NAME = exports.verify = exports.open = exports.signature = exports.sign = exports.extract_pkey = exports.generate_keypair = void 0;
const ge = require("./ge25519");
const sc = require("./sc25519");
const sha512 = require("../hash/sha512");
const arrays_1 = require("../util/arrays");
const vectVerify = require("../util/verify");
/**
...
function generate_keypair(seed, arrFactory) {
    ...
    const pk = arrays_1.makeArrayForOutput(32);
    ge.pack(pk, gepk, arrFactory);
    const sk = arrays_1.makeArrayForOutput(64);
...
function sign(m, sk, arrFactory) {
    ...
    const sm = arrays_1.makeArrayForOutput(m.length + 64);
...
function open(sm, pk, arrFactory) {
    ...
    const m = arrays_1.makeArrayForOutput(sm.length);
    m.set(sm);
    m.set(pk, 32);
