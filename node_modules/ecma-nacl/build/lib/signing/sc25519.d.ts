...
export declare function make_sc25519(arrFactory: Factory): sc25519;
/**
 * Analog of sc25519_from32bytes in crypto_sign/ed25519/ref/sc25519.c
 */
export declare function from32bytes(r: sc25519, x: Uint8Array, arrFactory: Factory): void;
/**
 * Analog of sc25519_from64bytes in crypto_sign/ed25519/ref/sc25519.c
 */
export declare function from64bytes(r: sc25519, x: Uint8Array, arrFactory: Factory): void;
/**
 ...
 */
export declare function add(r: sc25519, x: sc25519, y: sc25519, arrFactory: Factory): void;
/**
 * Analog of sc25519_mul in crypto_sign/ed25519/ref/sc25519.c
 */
export declare function mul(r: sc25519, x: sc25519, y: sc25519, arrFactory: Factory): void;
/**
