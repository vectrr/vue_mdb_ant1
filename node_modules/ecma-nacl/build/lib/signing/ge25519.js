...
exports.scalarmult_base = exports.double_scalarmult_vartime = exports.pack = exports.unpackneg_vartime = exports.base = exports.recycle_ge25519 = exports.make_ge25519 = void 0;
const fe = require("./fe25519");
const sc = require("./sc25519");
const ge_base = require("./ge25519_base.data");
...
function recycle_ge25519_aff(arrFactory, ...ges) {
    for (let i = 0; i < ges.length; i += 1) {
        const x = ges[i];
        arrFactory.recycle(x.x, x.y);
    }
}
function recycle_ge25519(arrFactory, ...ges) {
    for (let i = 0; i < ges.length; i += 1) {
        const x = ges[i];
 ...
 *  d
 */
const ge25519_ecd = new Uint32Array([0xA3, 0x78, 0x59, 0x13, 0xCA, 0x4D, 0xEB, 0x75, 0xAB, 0xD8,
 ...
 *  2*d
 */
const ge25519_ec2d = new Uint32Array([0x59, 0xF1, 0xB2, 0x26, 0x94, 0x9B, 0xD6, 0xEB, 0x56, 0xB1,
 ...
 *  sqrt(-1)
 */
const ge25519_sqrtm1 = new Uint32Array([0xB0, 0xA0, 0x0E, 0x4A, 0x27, 0x1B, 0xEE, 0xC4, 0x78, 0xE4,
 ...
 */
exports.base = make_ge25519(arrays_1.makeFactory());
