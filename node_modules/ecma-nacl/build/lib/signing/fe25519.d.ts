...
export declare function make_fe25519(arrFactory: Factory): fe25519;
/**
 ...
 */
export declare function pack(r: Uint8Array, x: fe25519, arrFactory: Factory): void;
/**
 * Analog of fe25519_iseq_vartime in crypto_sign/ed25519/ref/fe25519.c
 */
export declare function iseq_vartime(x: fe25519, y: fe25519, arrFactory: Factory): boolean;
/**
 ...
 */
export declare function getparity(x: fe25519, arrFactory: Factory): number;
/**
 ...
 */
export declare function neg(r: fe25519, x: fe25519, arrFactory: Factory): void;
/**
 ...
 */
export declare function sub(r: fe25519, x: fe25519, y: fe25519, arrFactory: Factory): void;
/**
 * Analog of fe25519_mul in crypto_sign/ed25519/ref/fe25519.c
 */
export declare function mul(r: fe25519, x: fe25519, y: fe25519, arrFactory: Factory): void;
/**
 * Analog of fe25519_square in crypto_sign/ed25519/ref/fe25519.c
 */
export declare function square(r: fe25519, x: fe25519, arrFactory: Factory): void;
/**
 * Analog of fe25519_invert in crypto_sign/ed25519/ref/fe25519.c
 */
export declare function invert(r: fe25519, x: fe25519, arrFactory: Factory): void;
/**
 * Analog of fe25519_pow2523 in crypto_sign/ed25519/ref/fe25519.c
 */
export declare function pow2523(r: fe25519, x: fe25519, arrFactory: Factory): void;
