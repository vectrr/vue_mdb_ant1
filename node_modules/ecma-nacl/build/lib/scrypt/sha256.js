...
exports.PBKDF2_SHA256 = exports.be32enc = exports.SHA256_Final = exports.SHA256_Update = exports.SHA256_Init = exports.recycleSha256Ctxs = exports.makeSha256Ctx = void 0;
/**
 * Analog of round in crypto_hashblocks/sha256/inplace/blocks.c
 * Length === 64.
 */
const round = new Uint32Array([0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b,
...
function recycleHmacSHA256Context(...ctxs) {
    let ctx;
    for (let i = 0; i < ctxs.length; i += 1) {
        ctx = ctxs[i];
