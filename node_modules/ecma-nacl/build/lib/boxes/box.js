...
exports.JWK_ALG_NAME = exports.KEY_LENGTH = exports.NONCE_LENGTH = exports.formatWN = exports.stream = exports.open = exports.pack = exports.calc_dhshared_key = exports.generate_pubkey = void 0;
const arrays_1 = require("../util/arrays");
const scalarmult_1 = require("./scalarmult");
const core_1 = require("./core");
const sbox = require("./secret_box");
...
function generate_pubkey(sk, arrFactory) {
    ...
    scalarmult_1.curve25519_base(pk, sk, arrFactory);
...
function calc_dhshared_key(pk, sk, arrFactory) {
    ...
    const s = arrays_1.makeArrayForOutput(32);
    scalarmult_1.curve25519(s, sk, pk, arrFactory);
    core_1.hsalsa20(s, n_to_calc_dhshared_key, s, stream_1.SIGMA);
    arrFactory.wipeRecycled();
    return s;
}
