...
exports.poly1305_verify = exports.poly1305 = void 0;
...
function mulmod(h, r, arrFactory) {
    let hr = arrFactory.getUint32Array(17), u = 0;
...
function poly1305(outArr, inArr, k, arrFactory) {
    let r = arrFactory.getUint32Array(17), h = arrFactory.getUint32Array(17), c = arrFactory.getUint32Array(17), inlen = inArr.length, inArrInd = 0;
    r[0] = k[0];
    r[1] = k[1];
    r[2] = k[2];
    r[3] = k[3] & 15;
...
function poly1305_verify(h, inArr, k, arrFactory) {
    ...
    let areSame = verify_1.v16(h, correct);
