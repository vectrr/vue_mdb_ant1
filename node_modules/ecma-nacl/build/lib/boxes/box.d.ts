 ...
 * secret key.
 */
export declare function generate_pubkey(sk: Uint8Array, arrFactory?: Factory): Uint8Array;
/**
 ...
 */
export declare function calc_dhshared_key(pk: Uint8Array, sk: Uint8Array, arrFactory?: Factory): Uint8Array;
/**
 ...
 * zeros.
 */
export declare function pack(m: Uint8Array, n: Uint8Array, pk: Uint8Array, sk: Uint8Array, arrFactory?: Factory): Uint8Array;
/**
 ...
 */
export declare function open(c: Uint8Array, n: Uint8Array, pk: Uint8Array, sk: Uint8Array, arrFactory?: Factory): Uint8Array;
export declare module stream {
    const pack: typeof sbox.pack;
    const open: typeof sbox.open;
}
export declare module formatWN {
     ...
     */
    function pack(m: Uint8Array, n: Uint8Array, pk: Uint8Array, sk: Uint8Array, arrFactory?: Factory): Uint8Array;
    /**
     ...
     * Array is a view of buffer, which has 32 zeros preceding message bytes.
     */
    function open(c: Uint8Array, pk: Uint8Array, sk: Uint8Array, arrFactory?: Factory): Uint8Array;
    const copyNonceFrom: typeof sbox.formatWN.copyNonceFrom;
    /**
     * @param pk is Uint8Array, 32 bytes long public key of message receiving
     * party.
     * @param sk is Uint8Array, 32 bytes long secret key of message sending
     ...
     */
    function makeEncryptor(pk: Uint8Array, sk: Uint8Array, nextNonce: Uint8Array, delta?: number, arrFactory?: Factory): sbox.Encryptor;
    /**
     * @param pk is Uint8Array, 32 bytes long public key of message receiving
     * party.
     * @param sk is Uint8Array, 32 bytes long secret key of message sending
     ...
     */
    function makeDecryptor(pk: Uint8Array, sk: Uint8Array, arrFactory?: Factory): sbox.Decryptor;
}
export declare const NONCE_LENGTH = 24;
export declare const KEY_LENGTH = 32;
export declare const JWK_ALG_NAME = "NaCl-box-CXSP";
