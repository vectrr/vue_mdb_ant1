 ...
 */
export declare function pack(m: Uint8Array, n: Uint8Array, k: Uint8Array, arrFactory?: Factory): Uint8Array;
/**
 ...
 */
export declare function open(c: Uint8Array, n: Uint8Array, k: Uint8Array, arrFactory?: Factory): Uint8Array;
/**
...
export declare module formatWN {
     ...
     */
    function pack(m: Uint8Array, n: Uint8Array, k: Uint8Array, arrFactory?: Factory): Uint8Array;
    /**
     ...
     * Array is a view of buffer, which has 32 zeros preceding message bytes.
     */
    function open(c: Uint8Array, k: Uint8Array, arrFactory?: Factory): Uint8Array;
    /**
     ...
     * nonce.
     */
    function makeEncryptor(key: Uint8Array, nextNonce: Uint8Array, delta?: number, arrFactory?: Factory): Encryptor;
    /**
     *
     ...
     */
    function makeDecryptor(key: Uint8Array, arrFactory?: Factory): Decryptor;
}
export declare const NONCE_LENGTH = 24;
export declare const KEY_LENGTH = 32;
export declare const POLY_LENGTH = 16;
export declare const JWK_ALG_NAME = "NaCl-sbox-XSP";
